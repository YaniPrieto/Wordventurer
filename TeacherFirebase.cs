...
//This code is for teacher side Firebase
...
public class TeacherFirebase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        FirebaseApp.CheckAndFixDependenciesAsync().ContinueWith(task =>
        {
            ...
            {
                warningLoginText.text = "fb error";
    ...
    private IEnumerator LoadUserData()
    {
        ...
        else
        {
            ...
            string tempo = snapshot.Child("HighScore").Value.ToString();
            PlayerPrefs.SetInt("HighScore", int.Parse(tempo));
